...
### Цель работы
Разработка архитектуры программного комплекса по теме научно-исследовательской работы: "Исследование методов обнаружения препятствий на основе машинного зрения для наземного робота".
